...
using MCU = nanoFramework.Hardware.Stm32;
using System;
using I2C = System.Device.I2c;
...
MCU.Configuration.SetPinFunction(21, DeviceFunction.I2C1_DATA);
MCU.Configuration.SetPinFunction(22, DeviceFunction.I2C1_CLOCK);

// For STM32, you can use the following
// Initialize I2C1 on STM32:
...
{
    isDevice = false;
    I2C.I2cDevice i2c = new(new I2C.I2cConnectionSettings(1, i));
    ...
    isDevice = res.Status == I2C.I2cTransferStatus.FullTransfer;
